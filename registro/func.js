...
function validar(Formulario){
	if(document.form1.rut.value==0){
	   	alert("Advertencia: Ingrese Rut de la Persona");
		document.form1.rut.focus();
		return false;
	}
	else if(document.form1.nombre.value==0){
	   	alert("Advertencia: Ingrese el Nombre de la Persona");
		document.form1.nombre.focus();
		return false;
	}
	else if(document.form1.sector.value==0){
   		alert("Advertencia: Ingrese o Busque Dirección");
...
function verificar(){
	...
	if(document.form1.rut.value.length < 10)
	{
		$("#resultadoBusqueda").html('');
			document.getElementById('resultadoBusqueda').style.backgroundColor = 'transparent';
	}
	else if (document.form1.rut.value.length == 10){
